...
class LEDStrip:
    ...
    def rainbow(self, wait_ms=100, iterations=1):
        self.transition(255, 0, 0, 0, 255, 0, wait_ms / 5)
        self.transition(0, 255, 0, 0, 0, 255, wait_ms / 5)
        self.transition(0, 0, 255, 0, 0, 255, wait_ms / 5)
        self.transition(255, 0, 255, 0, 0, 255, wait_ms / 5)
        self.transition(255, 255, 0, 255, 255, 0, wait_ms / 5)
